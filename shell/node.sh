...
then
    ...
    echo "192.168.32.20   node01.mheducation.com  node02" | sudo tee --append /etc/hosts 2> /dev/null && \
    echo "192.168.32.30   node02.mheducation.com  node03" | sudo tee --append /etc/hosts 2> /dev/null
